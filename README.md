...
``` 
python apgcc/run_folder_inference.py \
...
- Pass `--materialize_dataset` only when you want to persist the fabricated SHHA dataset to disk. By default the script now keeps everything in-memory so you can run inference without duplicating your image folder.
